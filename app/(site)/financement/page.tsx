...
export const metadata: Metadata = {
  title: "Financement — rendez votre entreprise finançable | Nedexia",
  description:
...
/**
 * /financement — ancienne home new_ui (promesse financement + diagnostic).
 * L’accueil `/` reprend la landing historique de main.
 */
